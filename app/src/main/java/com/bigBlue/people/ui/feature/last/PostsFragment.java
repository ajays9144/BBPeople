...
public class PostsFragment extends BaseFragment {
    ...
    /**
     * New instance posts fragment.
     *
     * @return the posts fragment
     */
    ...
    private void initRecyclerView() {
        recyclerViewAdapter = new BaseRecyclerViewAdapter(getContext(), commentsModels, Constants.ADAPTER.POSTS);
    ...
    private void getPosts() {
        ...
        Call<List<BaseModel>> call = apiServices.getPosts("1");
