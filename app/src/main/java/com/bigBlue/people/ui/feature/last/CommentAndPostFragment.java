...
/**
 * The type Comment and post fragment.
 */
public class CommentAndPostFragment extends BaseFragment {
    ...
    /**
     * New instance comment and post fragment.
     *
     * @return the comment and post fragment
     */
    public static CommentAndPostFragment newInstance() {
        return new CommentAndPostFragment();
    }
    ...
    private void initRecyclerView() {
        recyclerViewAdapter = new BaseRecyclerViewAdapter(getContext(), commentsModels, Constants.ADAPTER.COMMENT_AND_BODY);
    ...
    private void getCommentsPost() {
        ...
        Call<List<BaseModel>> call = apiServices.getCommentAndPost("1");
